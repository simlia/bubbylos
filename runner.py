...
class Runner(BoxLayout):
      ...
      fnished = BooleanProperty(False)
    def __init__(self
                total=10, steptime = 1, autorepeat = True
                bcolor=(0.49, 0.18, 0.97, 0.1),
         ...
         self.animation.on_progress = self.nextself.btn = Button(size_hint=(1, 0.1), pos_hint={'top': 1.0}, background_color=bcolor)
